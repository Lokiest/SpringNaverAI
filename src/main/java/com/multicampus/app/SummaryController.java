...
public class SummaryController {
	...
	public String summaryEnd(@RequestParam("title") String title, @RequestParam("content") String content) throws IOException {
		log.info("title : " + title);
		String clientId = "tsqbly5u4v";
		String clientsecret = "e7GujLBIFsfsvwLXHjGO8GtkRfi3u6E2jl8rTPoG";
		...
		if(responseCode == 200) {
			...
			log.info("error occur : " + responseCode);
